...
{
    /// <inheritdoc />
    public partial class AddUserLoginSessions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SSOUserId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefrenceCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    PayGateway = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectedLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelectedLocations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_TrackingCode",
                table: "PaymentHistories",
                column: "TrackingCode");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentHistories_User_Date",
                table: "PaymentHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_ValidTokens",
                table: "RefreshTokens",
                columns: new[] { "UserId", "IsRevoked", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SelectedLocations_LocationCode",
                table: "SelectedLocations",
                column: "LocationCode");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedLocations_User_Default",
                table: "SelectedLocations",
                columns: new[] { "UserId", "IsDefault" });

            migrationBuilder.CreateIndex(
                name: "IX_SelectedLocations_UserId",
                table: "SelectedLocations",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLoginSessions_AccessToken",
                table: "UserLoginSessions",
                column: "AccessToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserLoginSessions_SessionId",
                table: "UserLoginSessions",
                column: "SessionId",
                unique: true);
